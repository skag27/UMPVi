...
$query = "SELECT * FROM sticker INNER JOIN user ON user.userID = sticker.userID ORDER BY status,userType";
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Sticker Application</h1>
            ...
            <?php if (mysqli_num_rows($result) > 0){
              ...
              while($row = mysqli_fetch_assoc($result)){ 
                ...
                <tr stickerID='tr_<?= $stickerID ?>'>
                  ...
                  <td scope="row"><?php echo $row['userFullName']; ?></td>
                  <td scope="row"><?php echo $row['userMatricNum']; ?></td>
