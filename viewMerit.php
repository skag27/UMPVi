            ...
            <?php if (mysqli_num_rows($result) > 0){
              ...
              while($row = mysqli_fetch_assoc($result)){ 
                ...
                <tr>
                  ...
                  <td scope="row"><?php echo $row['meritObedientPosition']; ?></td>
                  <td scope="row"><?php echo $row['meritObedientPoint']; ?></td>
                </tr>
              <?php $i++;}}else{?>
                <tr>
                  <td scope="row" colspan="3">No merit awarded yet</td>
                </tr>
              <?php } ?>
              <tr>
